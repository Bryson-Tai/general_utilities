variable "aks_configs" {
  description = <<EOF
    ...
    role_based_access_control_enabled      : Whether to enable role-based access control, set this to true will also set `azure_active_directory_role_based_access_control.azure_rbac_enabled` to true, default is true.
